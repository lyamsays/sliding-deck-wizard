      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            ...
            <span className="bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent"> effortless</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
            ...
            <Link to="/create" className="text-primary font-medium flex items-center hover:text-primary/80 transition-colors">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
            ...
            <Link to="/themes" className="text-primary font-medium flex items-center hover:text-primary/80 transition-colors">
