...
const faqs = [
  ...
  { q: "How is Sliding.io different from other AI slide tools?", a: "Most AI presentation tools are built for general business use. Sliding.io is built specifically for educators — it understands audience types (undergrads vs PhD students), generates real pedagogical speaker notes, accepts document uploads up to 20MB, and is priced for individual educators rather than enterprise teams." },
