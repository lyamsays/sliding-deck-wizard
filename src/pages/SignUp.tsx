    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 max-w-sm w-full text-center">
          ...
          <Link to="/sign-in" className="text-primary text-sm font-medium hover:underline">
            Back to sign in
          </Link>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm">
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-gray-500 mt-1">Free to start — no credit card needed</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-purple-400 pr-10"
                    required
                  />
